...
TOOLSETS = {
    ...
    "hermes-opencode-desktop": {
        "description": "OpenCode Desktop toolset - full agent tools accessible via OpenCode Desktop WebSocket",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
